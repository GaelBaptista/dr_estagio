import './Cs.css'
import img_body from './Asset_3cs/imgBody___Blog_cs.png'



export function CsEmpresaInovadora() {
    return (
    <div className='blog-article-container'>
      <header className='header__blog_Cs'>
        <div className="header-banner_blog">
          <h1>Os 3 C's de uma Empresa Inovadora: Cultura, Colaboração e Criatividade</h1>
        </div>
